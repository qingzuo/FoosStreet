...
public class SetPreferenceActivity extends PreferenceActivity implements
	...
	private void operatePreference(Preference preference) {
		if (preference == mapply_wifiPreference) { // 点击了 "打开wifi"
			...
			Log.i(TAG, "Old Value=" + number_editPreference.getText()
					+ ", New Value="
	...
	public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen,
		...
		if (preference.getKey().equals("wifi_setting")) {
			...
			Intent i = new Intent(SetPreferenceActivity.this,
					OtherActivity.class); // OtherActivity只是一个简单的Activity
